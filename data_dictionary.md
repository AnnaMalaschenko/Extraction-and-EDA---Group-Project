...
| colorDetails | Categorical records of animal fur color |
| created_date | Date the animal record was created |
| description | Animal description text |
| energyLevel | Animal energy level from Low, Medium or High |
| id | Unique animal ID from RescueGroups |
| isCurrentVaccinations | Boolean record of whether animal was up to date with Vaccinations |
| isDeclawed | Boolean record of whether cat has been declawed or not |
| isHousetrained | Boolean record of whether animal is Housetrained or not |
...
| picture_count | Number of pictures available per animal |
| sex | Animal sex, Male or Female |
| sheddingLevel | Animal shedding level of fur from Moderate to High |
| size_current | Current animal size or weight value |
| sizeGroup | General size category, such as Small, Medium, Large or X-Large |
...
| video_count | Number of videos available per animal |
| vocalLevel | Animal vocal level |